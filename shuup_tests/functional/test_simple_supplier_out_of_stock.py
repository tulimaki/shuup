...
from shuup.core.models import AnonymousContact, Shipment
...
def test_simple_supplier_out_of_stock(rf):
    ...
    assert shop_product.is_orderable(supplier, anon, 1)
    ...
    assert not shop_product.is_orderable(supplier, anon, 1)
