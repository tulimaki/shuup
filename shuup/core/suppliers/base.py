...
class BaseSupplierModule(object):
    ...
    def get_orderability_errors(self, shop_product, quantity, customer):
        ...
        if stock_status.stock_managed or self.supplier.stock_managed:
    ...
    def ship_products(self, shipment, product_quantities):
        ...
        for product, quantity in product_quantities.items():
            if quantity > 0:
                ...
                if stock_status.stock_managed or self.supplier.stock_managed:  # Check stocks for stock managed supplier
