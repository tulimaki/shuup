# -*- coding: utf-8 -*-
# Generated by Django 1.11.14 on 2018-07-31 05:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_group', models.ForeignKey(blank=True, help_text='Select contact for this discount.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contact_group_discounts', to='shuup.ContactGroup', verbose_name='contact group')),
        ...
        migrations.AddField(
            model_name='discount',
            name='shops',
            field=models.ManyToManyField(blank=True, db_index=True, to='shuup.Shop', verbose_name='shops'),
        ),
    ]
