...
class CheckoutMethodPhase(CheckoutPhaseViewMixin, LoginView):
    ...
    def should_skip(self):
        return bool(self.request.customer)
    ...
    def form_valid(self, form):
        ...
        should_register = bool(int(checkout_choice_form.cleaned_data["register"]))
...
class RegisterPhase(CheckoutPhaseViewMixin, RegistrationNoActivationView):
    ...
    def should_skip(self):
        ...
        return bool(self.request.customer or not checkout_method_choice_is_registered)
